...
O padrão Adapter permite usar classes de terceiros ou herdadas, mesmo que sejam incompatíveis com a maior parte do seu código. Por exemplo, 
em vez de reescrever a interface de notificação do seu aplicativo para oferecer suporte a cada serviço de terceiros, como Slack, Facebook,
SMS ou (você escolhe), você pode criar um conjunto de wrappers especiais que adaptam as chamadas do seu aplicativo para uma interface e formato 
exigidos por cada classe de terceiros. -->
